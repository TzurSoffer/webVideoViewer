...
class SubpageApp:
    ...
    def subpage(self, name):
        ...
        return(self._subpageTemplateRenderer(frame))
        return render_template_string(self._subpageTemplateRenderer(name), videoFeedUrl=frame)
    
    def _subpageTemplateRenderer(self, frame):
        with open(self.subpageTemplate, "r") as f:
            template = f.read()
        while True:
            yield(render_template(self.subpageTemplate, videoFeedUrl=frame))
